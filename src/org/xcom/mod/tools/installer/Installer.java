...
final public class Installer extends Main {
    ...
    public void run() {
        ...
        try {
            ...
            // TODO CREATE COMPRESSOR GET CODE
    ...
    private static List<ResFile> makeUPKChanges(List<ResFile> files,
        ...
        int[] progress = calculateWorkProgress(files, upkFiles, threadsNum, sync);
        ...
        for (ResFile f : files) {
            ...
            try (FileChannel fc = FileChannel.open(upkFile, StandardOpenOption.READ,
                ...
                print(INSTALL, "SEARCHING [" + upkFile.getFileName(), "] FOR RESOURCE [",
                        f.getResName(), "]");
                print("BYTE SUM TO FIND [" + f.getBytesSum(), "]");
     ...
     */
    private static Worker[] doSearch(int threadsNum, Worker[] workers, Thread[] threads,
                                     int i, ByteBuffer buffer, RunInBackground sync,
                                     int[] progress, ResFile f)
                                                               throws InterruptedException {
    ...
    private static int[] calculateWorkProgress(List<ResFile> files,
        ...
        int[] passesForFile = new int[size];
        ...
        int progressStart = (99 - size - size);
