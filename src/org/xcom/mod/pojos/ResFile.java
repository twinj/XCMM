...
@XmlType(propOrder={"id", "resName", "upkFilename", "bytesSum", "searchHashLength", "searchHash", "changes", "XMod"})
@NamedQueries({
		...
		@NamedQuery(name = "ResFile.findByBytesSum", query = "SELECT r FROM ResFile r WHERE r.bytesSum = :bytesSum") })
