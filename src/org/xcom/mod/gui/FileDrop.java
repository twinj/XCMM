...
public class FileDrop {
	...
	public FileDrop(final java.awt.Component c, final boolean recursive,
			final Listener listener, final java.awt.Component p ) {
		this(null, // Logging stream
				c, // Drop target
				javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2,
						defaultBorderColor), // Drag border
	...
	public FileDrop(final java.awt.Component c,
			...
			final boolean recursive, final Listener listener,
			final java.awt.Component p ) {
		this(null, c, dragBorder, recursive, listener, p);
	} // end constructor
				...
				public void dragEnter(java.awt.dnd.DropTargetDragEvent evt) {
					...
					if (isDragOk(out, evt)) {
						...
						if (c instanceof javax.swing.JComponent) {
							...
							// DANIEL EDIT
							if (p != null)
								normalBorder = ((JComponent) p).getBorder();
							else
							...
							// DANIEL EDIT
							if (p != null)
								((JComponent) p).setBorder(dragBorder);
							else
				...
				public void drop(java.awt.dnd.DropTargetDropEvent evt) {
					...
					try { // Get whatever was dropped
						...
						if (tr.isDataFlavorSupported(java.awt.datatransfer.DataFlavor.javaFileListFlavor)) {
							...
							//java.util.Iterator<File> iterator = fileList
							//		.iterator();
							...
							if (listener != null)
								listener.filesDropped(fileList); // was array
						...
						else // this section will check for a reader flavor.
						{
							...
							for (int zz = 0; zz < flavors.length; zz++) {
								if (flavors[zz].isRepresentationClassReader()) {
									...
									if (listener != null)
										listener.filesDropped(createFileList(
												br, out));
						...
						if (c instanceof javax.swing.JComponent) {
							...
							// DANIEL EDIT
							if (p != null)
								((JComponent) p).setBorder(normalBorder);
							else
	...
	// Was a file array
	private static java.util.List<File> createFileList(BufferedReader bReader,
			PrintStream out) {
	...
	public static interface Listener {
		 ...
		 * @since 1.0
		 */
		public abstract void filesDropped(java.util.List<java.io.File> files);
